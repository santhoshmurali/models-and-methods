...
HRSourceData = read.table("1452762979_586__HR_Employee_Attrition_Data.csv", header = T, sep=",")
...
#Deciles = (HRDevScaledData_df$Prob * 10)
##HRDevScaledData_df$Deciles = round(Deciles,0)
#Temp_Data = HRDevScaledData_df
#Temp_Data[,c(sum("Deciles")), by = "Deciles"]
#class(Temp_Data$Deciles)




# For NN
# Use Rank Order Table for measuring model Performance
# Calcualte Decile
# Segment Repondants
# Cumulative % of Respnandants and Non Respondants
# K-S Statistics [Kolmogorov-Smirnoff]
# Lift Chart - Maximize the Seperaton
