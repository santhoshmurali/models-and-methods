...
salesData = pd.read_excel(path_to_data_excel)
...
# In[52] : Formatting the Predicted User Item Table
...
item_user_rating_complete.customer = item_user_rating_complete['customer'].astype('Int64')
...
# In[238]: Wrting the Results to Mongo DB
...
# Converting the table to json or dict format 
